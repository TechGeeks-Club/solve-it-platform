...
class Judge0Client:
    ...
    async def execute_code(
        self, source_code: str, language_id: int, test_cases: List[Dict]
    ) -> Dict:
        """
        ...
        try:
            ...
            logger.info(
                f"🔧 Executing with language_id: {language_id} (50=C, 71=Python)"
            )
            ...
            for i, result in enumerate(results):
                ...
                try:
                    ...
                    logger.debug(
                        f"Parsed status_id: {status_id}, status_name: {status_name}"
                    )
            ...
            logger.info(
                f"   Calculation: ({passed_count} / {total_tests}) * 100 = {score}"
            )
