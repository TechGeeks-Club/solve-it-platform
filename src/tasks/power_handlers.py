...
class TimeMachinePower(PowerHandler):
    ...
    def can_use(cls, team, task=None, tasksolution=None):
        ...
        if tasksolution.attempts < settings.max_attempts:
            return False, "You still have attempts remaining. Time Machine can only be used when you've reached max attempts."
    ...
    def use(cls, team, task=None, tasksolution=None):
        ...
        try:
            with transaction.atomic():
                ...
                return True, "⏰ Time Machine activated! You've been granted one extra attempt!"
