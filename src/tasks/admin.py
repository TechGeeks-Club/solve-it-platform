...
class SettingsAdmin(ModelAdmin):
    ...
    fieldsets = (
        ("Submission Settings", {"fields": ("max_attempts", "pass_threshold")}),
        ("Correction Settings", {"fields": ("manual_correction",)}),
        (
            "Event Settings",
            {
                "fields": ("rush_hour",),
...
class ShopPowerAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Cost & Availability", {"fields": ("cost", "is_active")}),
    )
